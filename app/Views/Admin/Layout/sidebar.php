            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="<?= base_url('logsheet/k3') ?>">K3</a>
                        <a class="nav-link" href="<?= base_url('logsheet/coalhandling') ?>">Coal Handling</a>
                        <a class="nav-link" href="<?= base_url('logsheet/unit') ?>">Unit</a>
                    </nav>
                </div>
